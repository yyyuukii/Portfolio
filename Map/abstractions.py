...
def restaurant_reviews(restaurant):
    """Return the reviews of the restaurant, which is a list of reviews."""
...
def restaurant_scores(restaurant):
    ...
    # BEGIN Question 1
    return [review_score(r) for r in restaurant_reviews(restaurant)]
    # END Question 1


### === +++ RESTAURANT ABSTRACTION BARRIER +++ === ###

def restaurant1_num_scores(restaurant):
